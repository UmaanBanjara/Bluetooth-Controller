...
class DPadControllerPage extends StatefulWidget {
  final BluetoothDevice device;
  final BluetoothCharacteristic characteristic;

  const DPadControllerPage({
    Key? key,
  ...
  @override
  State<DPadControllerPage> createState() => _DPadControllerPageState();
}

class _DPadControllerPageState extends State<DPadControllerPage> {
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: _isPressed[key]! ? Colors.red.withOpacity(0.5) : Colors.black.withOpacity(0.4),
  ...
  Widget build(BuildContext context) {
    ...
    final dPadSize = screenHeight * 0.55;
    final buttonWidth = dPadSize / 3;
    final buttonHeight = dPadSize / 3;
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [
            // Main D-Pad layout - Traditional cross pattern
            Center(
              child: Container(
                width: dPadSize,
                height: dPadSize,
